...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002838937528'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002855139376').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002554393480') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-4918472021').split()]  # For Multiple Id Use One Space Between Each.
